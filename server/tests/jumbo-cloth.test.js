...
describe('Cloth Controller Tests', () => {
    ...
    it('should handle error when getting clothes', async () => {
        ...
        const response = await supertest(app)
            .get('/v1/api/jumbo-poker/clothes')
            .set('Authorization', `${authToken}`);
    
        expect(response.status).toBe(500);
        expect(response.body).toEqual({ success: false, message: 'An error occurred during getting the Jumbo Poker Clothes!' });
    ...
    it('shouldn`t upload a new cloth', async () => {
        ...
        expect(response.status).toBe(500);
        expect(response.body).toEqual({ success: false, message: `An error occurred during upload the new Jumbo Poker Cloth!` });
    ...
    it('shouldn`t patch an existing cloth', async () => {
        ...
        expect(response.status).toBe(500);
        expect(response.body).toEqual({ success: false, message: `An error occurred during patching the desired Jumbo Poker Cloth!` });
    ...
    it('it should handle error when deleting a cloth', async () => {
        ...
        expect(response.status).toBe(500);
        expect(response.body).toEqual({ success: false, message: `An error occurred during delete the desired Jumbo Poker Cloth!` });
