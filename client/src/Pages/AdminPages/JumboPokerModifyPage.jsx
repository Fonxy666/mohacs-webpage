...
const getClothes = async () => {
    try {
        const response = await fetch("https://localhost:3443/v1/api/jumbo-poker/clothes", {
            method: "GET",
            headers: {
...
const deleteCloth = async (id, token) => {
    try {
        const response = await fetch(`https://localhost:3443/v1/api/jumbo-poker/${id}/delete`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `${token}`
